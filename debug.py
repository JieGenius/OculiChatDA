...
from lagent.agents import CALL_PROTOCOL_CN, ReAct, ReActProtocol
...
llm = HFTransformer(
    path='/share/model_repos/internlm2-chat-7b', meta_template=META)
...
chatbot = ReAct(
    ...
    action_executor=ActionExecutor(
        actions=[FundusDiagnosis(model_path=model_path)]),
    protocol=ReActProtocol(call_protocol=CALL_PROTOCOL_CN))

res = chatbot.chat(
    '我上传了一张图片，图片地址为/root/GlauClsDRGrading/data/refuge/images/g0001.jpg,'
    ' 请看看我是否患有青光眼')
